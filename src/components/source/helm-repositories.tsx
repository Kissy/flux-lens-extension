...
export class HelmRepositories extends React.Component<
  ...
  render(): ReactNode {
    return (
      <Renderer.Component.KubeObjectListLayout
        className="FluxHelmRepositories"
        store={helmRepositoriesStore}
        ...
        renderTableContents={(helmRepository: HelmRepository) => [
          ...
          <a href="#" onClick={Common.Util.prevDefault(helmRepository.openUrl)}>
          ...
          {
            title: helmRepository.getStatusMessage(),
            className: kebabCase(helmRepository.getStatusMessage())
          }
        ]}
      />
    );
