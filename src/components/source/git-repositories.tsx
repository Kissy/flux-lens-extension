...
export class GitRepositories extends React.Component<{ extension: Renderer.LensExtension }, any> {

    render() {
        return (
            <Renderer.Component.KubeObjectListLayout
                className="FluxGitRepositories" store={gitRepositoriesStore}
                ...
                renderTableContents={(fluxGitRepository: GitRepository) => [
                    ...
                    { title: fluxGitRepository.getStatusMessage(), className: kebabCase(fluxGitRepository.getStatusMessage()) }
                ]}
            />
        )
    }
