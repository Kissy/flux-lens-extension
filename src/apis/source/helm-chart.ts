...
export class HelmChart extends Renderer.K8sApi.KubeObject<KubeObjectMetadata, HelmChartStatus, HelmChartSpec> {
    ...
    getSourceDetailUrl(): string {
        ...
        const sourceId = { namespace: this.metadata.namespace, name: sourceRef.name }
