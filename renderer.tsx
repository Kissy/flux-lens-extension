...
import {GitRepositoryDetails, FluxGitRepositoryDetailsProps} from "./src/components/source/git-repository-details";
import {HelmChartDetails, FluxHelmChartDetailsProps} from "./src/components/source/helm-chart-details";
    ...
    kubeObjectDetailItems = [
        {
            ...
            components: {
                Details: (props: FluxGitRepositoryDetailsProps) => <GitRepositoryDetails {...props} />
            }
        },
        {
            kind: HelmChart.kind,
            apiVersions: ["source.toolkit.fluxcd.io/v1beta1"],
            components: {
                Details: (props: FluxHelmChartDetailsProps) => <HelmChartDetails {...props} />
            }
        },
        {
            ...
            components: {
                Details: (props: FluxKustomizationDetailsProps) => <KustomizationDetails {...props} />
            }
        }
    ]
}
