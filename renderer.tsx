...
import {KustomizationRequestReconciliationMenuItem} from "./src/components/kustomize/kustomization-request-reconciliation-menu-item";
import {GitRepositoryRequestReconciliationMenuItem} from "./src/components/source/git-repository-request-reconciliation-menu-item";
import {ClusterPageMenuComponents} from "@k8slens/extensions/dist/src/extensions/registries";
...
export default class FluxExtension extends Renderer.LensExtension {
  ...
  clusterPageMenus = [
    ...
    },
    {
      ...
      components: {} as ClusterPageMenuComponents
    },
    {
      parentId: "flux",
      title: "Helm Charts",
  ...
  kubeObjectMenuItems = [
    {
      ...
      apiVersions: ["source.toolkit.fluxcd.io/v1beta1", "source.toolkit.fluxcd.io/v1beta2"],
      components: {
        MenuItem: GitRepositoryRequestReconciliationMenuItem
      }
    },
    {
      kind: Kustomization.kind,
      apiVersions: ["kustomize.toolkit.fluxcd.io/v1beta1", "kustomize.toolkit.fluxcd.io/v1beta2"],
      components: {
        MenuItem: KustomizationRequestReconciliationMenuItem
      }
    }
  ];
